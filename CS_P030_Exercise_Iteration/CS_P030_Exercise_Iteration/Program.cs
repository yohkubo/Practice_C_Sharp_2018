...
namespace CS_P030_Exercise_Iteration
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Exercise 6
            List<string> names6 = new List<string>() { "Toshihiro", "Machiko", "Ryusuke", "Mana", "Kensuke", "Yohei" };
